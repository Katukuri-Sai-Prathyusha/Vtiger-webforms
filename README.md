                        ...
                        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.9/css/select2.min.css">
                                        <meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
                                                                <link rel="stylesheet" href="https://filippettiyachtsrl.od2.vtiger.com//layouts/v8/lib/intl-tel-input/build/css/intlTelInput.min.css">
                                        <form id="__vtigerWebForm_2" name="FILIPPETTI YACHTS" action="https://filippettiyachtsrl.od2.vtiger.com/modules/Webforms/capture.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <input type="hidden" name="publicid" value="d1b5b5e03206515ce42106af0d0f4a62">
                        <input type="hidden" name="urlencodeenable" value="1">
                        <input type="hidden" name="name" value="FILIPPETTI YACHTS">
                         <input type="hidden" name="__vtCurrency" value="1">
										...
										<label>
											...
											*                                            										</label>
								                                ...
								                                <td>
									                                                                                                                                                                                                                                    <input type="text" name="lastname" maxlength="80" data-label="" value="" required="">                                                                    </td><td><input type="checkbox" name="vtField" value="1" style="display:none !important" tabindex="-1" autocomplete="off"></td></tr>
                                                                                                                                                            								                                <tr>
                                									<td>
										<label>
																																																								Primary Email
											...
											*                                            										</label>
                                            ...
                                            <option value="">Select Value</option>
                                                    ...
                                                    Surveyor
                                                                                            ...
                                                                                            <option value="Supplier/ Technician / Vendor">
                                                    Supplier/ Technician / Vendor
                                                </option>
                                                                                            <option value="Boat Manager">
                                                    Boat Manager
                                                </option>
										...
										<label>
								                                ...
								                                <td>
									                                                                                                                                                                                                                                    <input type="text" name="phone" maxlength="50" data-label="" value="" data-type="phone">                                                                    </td></tr>
                                                                                                                                                            								                                <tr>
                                									<td>
										<label>
								                                ...
								                                <td>
									                                                                                                                                                                                            <input type="hidden" name="cf_contacts_newsletterauthorization" data-label="" value="0">
                                                                                    <input type="checkbox" name="cf_contacts_newsletterauthorization" data-label="" value="1">
                                                                                                            </td></tr>
                                                                                                                                                            								                                <tr>
                                									<td>
										<label>
								                                ...
								                                <td>
									                                                                                                                                                                                            <input type="hidden" name="cf_contacts_privacypolicyauthorization" data-label="" value="0">
                                                                                    <input type="checkbox" name="cf_contacts_privacypolicyauthorization" data-label="" value="1">
                                                                                                            </td></tr>
                                                                                                                                                            								                                <tr>
                                									<td>
										<label>
								                                ...
								                                <td>
									                                                                                                                                                                                                                                                										                                                                                                                                                                                                                                                                                    																				                                        <select name="cf_contacts_ownedyacht" data-label="label:Owned+Yacht">
                                            <option value="">Select Value</option>
                                                                                            <option value="Yes">
                                                    Yes
                                                </option>
                                                    ...
                                                    No
                                									...
                                									<td>
										<label>
																																																								Yacht Owned -  Model and Year
											                                            										</label>
									</td>
								                                <td>
									                                                                                                                                                                                                                                    <input type="text" name="cf_contacts_modelyachtowned" maxlength="50" data-label="" value="">                                                                    </td></tr>
                                                                                                                                                            								                                <tr>
                                									<td>
										<label>
																																																								Interested in
								                                ...
								                                <td>
									                                                                                                                                                                                                                                                										                                                                                                                                                                                                                                                                                    																				                                        <select name="cf_contacts_interestedin" data-label="label:Interested+in">
                                            <option value="">Select Value</option>
                                                                                            <option value="New Yacht">
                                                    New Yacht
                                                </option>
                                                                                            <option value="Pre Owned Yacht">
                                                    Pre Owned Yacht
                                                </option>
                                                                                            <option value="New and Pre Owned Yacht">
                                                    New and Pre Owned Yacht
                                                </option>
                                                                                            <option value="Refitting">
                                                    Refitting
                                                </option>
                                                    ...
                                                    Charter
                                                                                            ...
                                                                                            <option value="Represent Filippetti Yachts">
                                                    Represent Filippetti Yachts
                                                </option>
                                                                                            <option value="Other">
                                                    Other
                                                </option>
										...
										<label>
								                                ...
								                                <td>
									                                                                                                                                                                                                                                                										                                                                                                                                                                                                                                                                                    																				                                        <select name="cf_contacts_length" data-label="label:Length">
                                            <option value="">Select Value</option>
                                                                                            <option value="up to 10mt/33ft">
                                                    up to 10mt/33ft
                                                </option>
                                                                                            <option value="10mt-15mt (33ft - 49ft)">
                                                    10mt-15mt (33ft - 49ft)
                                                </option>
                                                                                            <option value="15mt-20mt (50ft - 66ft)">
                                                    15mt-20mt (50ft - 66ft)
                                                </option>
                                                                                            <option value="20mt-25mt (67ft - 82ft)">
                                                    20mt-25mt (67ft - 82ft)
                                                </option>
                                                                                            <option value="25mt-30mt (82ft - 98ft)">
                                                    25mt-30mt (82ft - 98ft)
                                                </option>
                                                                                            <option value="30mt-35mt (99ft - 115ft)">
                                                    30mt-35mt (99ft - 115ft)
                                                </option>
                                                                                            <option value="35mt/116ft and more">
                                                    35mt/116ft and more
                                                </option>
                                                                                    </select>
